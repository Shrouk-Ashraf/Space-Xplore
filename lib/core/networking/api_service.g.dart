...
class _ApiService implements ApiService {
  ...
  @override
  Future<CrewMemberModel> getCrewMemberById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CrewMemberModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = CrewMemberModel.fromJson(_result.data!);
    return value;
  }
